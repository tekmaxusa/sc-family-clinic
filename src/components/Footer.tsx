          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                ...
                <a href={`mailto:${CLINIC_INFO.email}`} className="text-slate-300 hover:text-white underline decoration-cta underline-offset-4">
                  {CLINIC_INFO.email}
                </a>
              </p>
              <p>
                <span className="font-semibold mr-2">Website:</span>
                <a href={CLINIC_INFO.websiteUrl} target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-white underline decoration-cta underline-offset-4">
          ...
          <div>
            ...
            <div className="mt-8 p-4 bg-white/5 rounded-lg border border-white/10">
              <p className="text-xs text-slate-400 italic">
                Now accepting new patients. Medicare welcome. Accepting United Healthcare Advantage and Traditional (Molina). Uninsured patients—please call for insurance verification.
              </p>
            </div>
          </div>
        </div>
