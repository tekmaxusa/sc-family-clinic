      ...
      <section className="bg-white pt-16 pb-12 md:pt-24 md:pb-20">
        <div className="max-content">
          ...
          >
            ...
            <p className="text-xl text-slate-600 leading-relaxed">{ins.intro}</p>
          </motion.div>
          ...
          <div className="max-prose-content mx-auto space-y-12">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {ins.plans.map((plan, i) => (
                  <div
                    key={i}
                    className="flex items-center p-4 bg-white rounded-2xl border border-slate-200 shadow-sm"
                  >
            ...
            >
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-8">{ins.uninsuredBody}</p>
              <a
                href={`tel:${CLINIC_INFO.phone}`}
                className="inline-flex items-center px-8 py-4 border-2 border-primary text-primary font-bold rounded-full hover:bg-slate-50 transition-all"
              >
                <Phone className="w-5 h-5 mr-2" />
                {ins.uninsuredCall} {CLINIC_INFO.phoneDisplay}
              </a>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-100 card-shadow"
            >
              <h2 className="text-2xl font-bold text-primary mb-8">{ins.bringTitle}</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {ins.bringItems.map((item, i) => (
